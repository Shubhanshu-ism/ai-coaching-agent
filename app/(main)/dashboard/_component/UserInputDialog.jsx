          ...
          <DialogDescription asChild>
            <div className="mt-3">
              <h2 className="text-black mt-5">
                Enter the topic you want to master your skill{" "}
                {coachingOption.name}
              </h2>
              <Textarea
              ...
              />
              <h2 className="text-black mt-5 text-center">
                ...
                {CoachingExpert.map((expert, index) => (
                  ...
                  >
                    <Image
                      ...
                      width={100}
                      height={100}
                      className={`rounded-2xl h-[80px] w-[80px] object-cover hover:scale-105 transition-all cursor-pointer p-1  ${selectedExpert == expert.name && "border border-primary"}`}
                    />
